...
function clientMetadata() {
  ...
  return {
    label: desktop ? "Tung Tung Tung Sahur Code Desktop" : "Tung Tung Tung Sahur Code Web",
    ...
    const cloudSession = CloudSession.of({
      clerkToken: Effect.gen(function* () {
        ...
        if (session === null) {
          return yield* new ConnectionBlockedError({
            reason: "authentication",
            detail: "Sign in to Tung Tung Tunnel to connect this environment.",
          });
        }
        ...
        if (token === null) {
          return yield* new ConnectionBlockedError({
            reason: "authentication",
            detail: "The Tung Tung Tunnel session is unavailable.",
          });
        }
        return token;
      }),
