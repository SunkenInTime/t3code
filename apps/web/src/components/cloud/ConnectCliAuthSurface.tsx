  ...
  return (
    <AuthSurfaceShell>
      <ConnectCliAuthMessage
        ...
        description={
          isSignedIn
            ? "Redirecting to authorize Tung Tung Tunnel for your CLI…"
            : "Sign in to continue authorizing Tung Tung Tunnel for your CLI."
        }
      />
      {isLoaded && !isSignedIn ? (
        <div className="mt-6">
  ...
  return (
    <AuthSurfaceShell>
      ...
      <p className="mt-6 text-xs leading-relaxed text-muted-foreground">
        ...
        their machine to your Tung Tung Tunnel account while it is valid.
      </p>
    </AuthSurfaceShell>
  );
}
