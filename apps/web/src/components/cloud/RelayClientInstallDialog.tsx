    ...
    >
      <DialogPopup className="max-w-md" showCloseButton={isConfirming}>
        <DialogHeader>
          ...
          <DialogDescription>
            {isInstalling
              ? "Tung Tung Tung Sahur Code is preparing this environment for secure access through Tung Tung Tunnel."
              : "Tung Tung Tung Sahur Code needs the relay client to make this environment available through Tung Tung Tunnel."}
          </DialogDescription>
        </DialogHeader>
          ...
          {isInstalling ? (
            <div className="space-y-2.5">
              ...
              <p className="text-xs leading-relaxed text-muted-foreground">
                Keep Tung Tung Tung Sahur Code open while the relay client is installed.
              </p>
            </div>
          ) : (
            <div className="rounded-xl border border-border/70 bg-muted/35 p-3">
              ...
              <p className="mt-1 text-sm leading-relaxed text-muted-foreground">
                Tung Tung Tung Sahur Code will download and install version{" "}
